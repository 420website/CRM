    ...
    try {
      ...
      if (data.pin_valid) {
        ...
        if (data.needs_email_verification) {
          ...
          console.log(`Helllo ${data.two_fa_email}`);
      ...
      if (
        err.message.includes("System locked") ||
        err.message.includes("multiple failed PIN attempts")
      ) {
              ...
              <div className="mx-auto flex items-center justify-center h-12 w-12 rounded-full bg-red-100 mb-4">
                ...
                >
                  <path
                    ...
                    strokeWidth="2"
                    d="M12 15v2m0 0v2m0-2h2m-2 0H8m4-9V6m0 0V4m0 2h2m-2 0H6"
                  />
                </svg>
              </div>
