        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-gray-300 text-sm leading-relaxed mb-4">
              Providing confidential and accessible Hepatitis C and HIV testing
              services for people in Ontario who have been exposed. Our team
              includes clinicians, phlebotomists, and peers with lived
              experience offering testing in 4 simple steps, completed in just
              20 minutes.
            </p>
            <div className="text-gray-300 text-sm">
              <p>
                <strong>Confidential</strong> • <strong>Professional</strong> •{" "}
                <strong>Judgment-Free</strong>
              </p>
            </div>
          ...
          <div>
            ...
            <div className="mt-6 pt-4">
              <p className="text-gray-500 text-sm">
                © 2025 my420.ca | All rights reserved.
              </p>
            </div>
          </div>
        </div>
