        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="text-xl text-gray-200 max-w-3xl mx-auto">
              ...
              for individuals with risk factors for Hepatitis C and HIV across
              Ontario.
            </p>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
                ...
                <div className="bg-red-50 border-l-4 border-red-500 p-6 rounded-r-lg">
                  ...
                  <ul className="space-y-2 text-gray-700">
                    <li className="flex items-start space-x-2">
                      ...
                      <span>
                        <strong>Antibody Test:</strong> Shows if you've ever
                    ...
                    <li className="flex items-start space-x-2">
                      <span className="text-red-600">•</span>
                      <span>
                        <strong>RNA Test:</strong> Confirms current infection
                        and viral load
                      </span>
                    </li>
                    <li className="flex items-start space-x-2">
                      <span className="text-red-600">•</span>
                      <span>
                        <strong>Genotype Testing:</strong> Determines the best
                        treatment approach
                      </span>
                    </li>
                  </ul>
                ...
                <div className="bg-purple-50 border-l-4 border-purple-500 p-6 rounded-r-lg">
                  ...
                  <ul className="space-y-2 text-gray-700">
                    ...
                    <li className="flex items-start space-x-2">
                      <span className="text-purple-600">•</span>
                      <span>
                        <strong>Laboratory Test:</strong> Confirmatory testing
                        if needed
                      </span>
                    </li>
                  </ul>
            ...
            <div>
              <h2 className="text-3xl font-bold text-gray-900 mb-4">
                📋 The 420 Process
                <span className="block text-2xl font-medium text-gray-700 mt-2">
              ...
              <div className="space-y-6">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      Review and provide informed consent regarding testing
                      procedures, privacy practices and next steps.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      Quick and minimally invasive testing procedures performed
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      Receive comprehensive information about prevention
                      strategies, risk reduction, and available treatment
                      options.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      Receive your test results with clear explanations and
                      connections to appropriate next steps if needed.
                    </p>
                  </div>
                </div>
              </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            <div className="bg-white rounded-lg shadow-md p-6">
              ...
              <p className="text-gray-600">
                Direct referrals to specialists and treatment programs for
                positive results.
              </p>
            </div>
            ...
            <div className="bg-white rounded-lg shadow-md p-6">
              ...
              <p className="text-gray-600">
                Information about prevention, treatment options, and living with
                HIV/Hepatitis C.
              </p>
            </div>
            ...
            <div className="bg-white rounded-lg shadow-md p-6">
              ...
              <p className="text-gray-600">
                Counseling and mental health resources to support overall
                well-being.
              </p>
            </div>
            ...
            <div className="bg-white rounded-lg shadow-md p-6">
              ...
              <p className="text-gray-600">
                Practical strategies and supplies to reduce health risks and
            ...
            <div className="bg-white rounded-lg shadow-md p-6">
              ...
              <p className="text-gray-600">
                Connection with others who have similar experiences and
                challenges.
              </p>
            </div>
          </div>
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <p className="text-gray-700">
                    Visits high-risk communities on rotating basis across
                    Ontario
                  </p>
                </div>
                <div>
                ...
                <div>
                  ...
                  <p className="text-gray-700">
                    Call for current schedule and locations
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-gray-200 rounded-lg p-8 border border-gray-400">
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <p className="text-gray-700">
                    Register online or call to schedule
                  </p>
                </div>
              </div>
            </div>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="space-y-4">
            <div className="bg-white rounded-lg shadow-md p-6">
              ...
              <p className="text-gray-700">
                Yes, all testing services are completely free. We believe
                financial barriers should never prevent someone from knowing
                their health status.
              </p>
            </div>
            ...
            <div className="bg-white rounded-lg shadow-md p-6">
              ...
              <p className="text-gray-700">
                Your information is strictly confidential and protected by
                privacy laws. We never share your information without your
                explicit consent.
              </p>
            </div>
            ...
            <div className="bg-white rounded-lg shadow-md p-6">
              ...
              <p className="text-gray-700">
                We provide immediate support, counseling, and connect you with
                treatment services.
                <br />
                <br />
                Both Hepatitis C and HIV are treatable with modern medications.
              </p>
            </div>
            ...
            <div className="bg-white rounded-lg shadow-md p-6">
              ...
              <p className="text-gray-700">
                While we ask for health card information during registration, we
                can provide testing services if you don't have your card or it's
                expired, as long as you are an Ontario resident.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="pt-4 pb-4 bg-black text-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl mb-4 text-gray-300">
            Take the first step toward better health. Registration is quick,
