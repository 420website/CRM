...
const Home = () => {
  ...
  return (
    <div className="bg-white">
      <Helmet>
        <title>
          Free Hepatitis C Testing | Hepatitis C Ontario Services | MY420.CA
        </title>
        <meta
          name="description"
          content="Leading Hepatitis C testing and Hepatitis C Ontario services. Free confidential testing, 2000+ screened, 98% linked to care, 97% treatment adherence. Professional Hepatitis C program."
        />
        <meta
          name="keywords"
          content="hepatitis C, hepatitis c ontario, free hepatitis C testing, hepatitis C testing ontario, confidential hepatitis C, rapid hepatitis C testing, hepatitis C treatment ontario, hepatitis C services"
        />
        <link rel="canonical" href="https://my420.ca/" />
        <meta
          property="og:title"
          content="Free Hepatitis C Testing | Hepatitis C Ontario Services"
        />
        <meta
          property="og:description"
          content="Leading Hepatitis C and Hepatitis C Ontario provider. 2000+ screened, 98% linked to care, 97% treatment adherence. Free 20-minute testing."
        />
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="text-center">
            ...
            <p className="text-xl text-gray-200 mb-4 leading-relaxed max-w-3xl mx-auto">
              Get tested for Hepatitis C and HIV in just 4 simple steps,
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mt-4 mb-6">
            <p className="text-lg text-gray-700 mb-6">
              Ready to get started? Our process is quick, confidential, and
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mb-4">
            ...
            >
              ...
              <div className="text-gray-400 text-sm mt-2">
                People who inject/share drug equipment
              </div>
            </div>
          ...
          <div className="text-center mt-4 mb-4">
            <p className="text-lg text-gray-300 mb-6">
              <strong>Making a real difference in our community.</strong> Every
              test, every connection to care, every dollar of support provided
              helps save lives and improve health outcomes.
            </p>
            <Link
              to="/about"
      ...
      <section className="pt-4 pb-4 bg-gray-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
            <div className="bg-white rounded-lg shadow-md p-6 border border-gray-300 text-center">
              ...
              <p className="text-gray-700 text-sm">
                ...
                <br />
                showing how common exposure really is
              </p>
            </div>
            ...
            <div className="bg-white rounded-lg shadow-md p-6 border border-gray-300 text-center">
              ...
              <p className="text-gray-700 text-sm">
                Of those exposed, continue to test
                <br />
            ...
            <div className="bg-white rounded-lg shadow-md p-6 border border-gray-300 text-center">
              ...
              <p className="text-gray-700 text-sm">
                People are unaware they can acquire
                <br />
                HCV and HIV from sharing pipes
              </p>
            </div>
          </div>
          ...
          <div className="text-center mb-4">
            ...
            <p className="text-xl text-gray-700 max-w-3xl mx-auto">
              Certain activities can increase your
              <br />
              risk of Hepatitis C and HIV. Testing
              <br />
              is recommended if you have any of
              <br />
              these risk factors.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            <div className="bg-white rounded-lg shadow-md p-6 border border-gray-300">
              ...
              <p className="text-gray-700">
                Sharing needles, syringes, pipes, or
                <br />
                other drug equipment significantly
                <br />
                increases infection risk. Many don't
                <br />
                realize pipes transmit HCV and HIV.
              </p>
            </div>
            ...
            <div className="bg-white rounded-lg shadow-md p-6 border border-gray-300">
              ...
              <p className="text-gray-700">
                Tattoos, piercings, or
                <br />
                medical procedures with unsterile
                <br />
                equipment can transmit infections.
              </p>
            </div>
          ...
          <div className="text-center mt-4 mb-4">
            <p className="text-lg text-gray-800 mb-6">
              <strong>Remember:</strong> Many people with Hepatitis C<br />
              or HIV have no symptoms. Testing is the
              <br />
              only way to know your status.
            </p>
            <Link
              to="/register#registration-form"
              className="bg-black hover:bg-gray-800 text-white px-8 py-3 rounded-lg font-semibold text-lg transition-colors duration-200"
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-4">
            ...
            <p className="text-xl text-gray-700">
              Comprehensive testing and support services designed with you in
              mind.
            </p>
          </div>
            ...
            <div className="bg-gray-50 rounded-lg p-8 border border-gray-300">
              ...
              <ul className="space-y-3 text-gray-800">
                <li className="flex items-start space-x-2">
                  ...
                  <span>
                    Rapid HCV & HIV antibody testing (results in 20 minutes)
                  </span>
                </li>
                <li className="flex items-start space-x-2">
                  <span className="text-black">•</span>
      ...
      <section className="pt-4 pb-2 bg-gray-100">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl mb-6 text-gray-700">
            Ready to get tested? Have questions? Contact us for confidential
            support.
          </p>
          <div className="bg-white rounded-lg shadow-md p-6 border border-gray-300 mb-6">
            ...
            <p className="text-gray-600 mt-2 mb-4">
              Same number for phone, text, and fax
            </p>
          ...
          <div className="text-center mt-4 mb-4">
            <p className="text-lg text-gray-700 mb-4">
              <strong>Get started today!</strong> Register for testing or send
      ...
      <section className="pt-0 pb-4 bg-white text-black">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="text-center mt-4 mb-2">
            <p className="text-xl mb-6 text-gray-700">
              Registration is quick, confidential, and the first step toward
              getting support.
            </p>
            <Link
              to="/register#registration-form"
