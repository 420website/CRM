...
import { WebpageServices } from "../../services/webpageService";
...
const ValidationIcon = ({ isValid, hasValue }) => {
  ...
  return (
    <span
      className={`ml-2 text-lg font-bold ${isValid ? "text-green-600" : "text-red-600"}`}
    >
      {isValid ? "✓" : "✗"}
    </span>
  );
...
const Register = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    const result = await WebpageServices.send_register_message(formData);

    if (result.success) {
      setSubmitStatus({
        type: "success",
        message:
          "Registration successful! We will contact you soon to schedule your testing appointment.",
        ...
        <div className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-white rounded-lg shadow-md p-8 text-center border border-gray-300">
            ...
            <p className="text-lg text-gray-800 mb-6">
              Thank you for registering! We will contact you soon to schedule
              your testing appointment.
            </p>
            <div className="bg-gray-100 border border-gray-300 rounded-lg p-4 mb-6">
              <p className="text-sm text-black">
                <strong>Registration ID:</strong>{" "}
                {submitStatus.registrationId || "Pending"}
              </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="text-xl text-gray-200">
              If you share drug equipment you are at high risk and should be
              tested
            </p>
          </div>
        </div>
            ...
            <div className="space-y-4">
              <div className="bg-white rounded-lg shadow-md px-8 pb-8 pt-4 border border-gray-300">
                ...
                <p className="text-gray-700 mb-6">
                  Our program has successfully screened thousands of at-risk
                  people across Ontario and connected them to treatment and
                  support services.
                </p>
            ...
            >
              <div className="text-center mb-8">
                ...
                <p className="text-lg text-gray-700">
                  Complete this form to register for free and confidential
                  Hepatitis C and HIV testing and treatment.
                </p>
              </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div>
                  ...
                  >
                    First Name *
                    <ValidationIcon
                      isValid={fieldValidation.first_name?.isValid}
                      hasValue={fieldValidation.first_name?.hasValue}
                    />
                  </label>
                  <input
                    type="text"
                    ...
                    className={`w-full px-3 py-2 border rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-black ${
                      errors.first_name
                        ? "border-red-500"
                        : fieldValidation.first_name?.hasValue
                          ? fieldValidation.first_name?.isValid
                            ? "border-green-500"
                            : "border-red-500"
                          : "border-gray-400"
                    }`}
                ...
                <div>
                  ...
                  >
                    Last Name *
                    <ValidationIcon
                      isValid={fieldValidation.last_name?.isValid}
                      hasValue={fieldValidation.last_name?.hasValue}
                    />
                  </label>
                  <input
                    type="text"
                    ...
                    className={`w-full px-3 py-2 border rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-black ${
                      errors.last_name
                        ? "border-red-500"
                        : fieldValidation.last_name?.hasValue
                          ? fieldValidation.last_name?.isValid
                            ? "border-green-500"
                            : "border-red-500"
                          : "border-gray-400"
                    }`}
                ...
                <div>
                  ...
                  >
                    Date of Birth *
                    <ValidationIcon
                      isValid={fieldValidation.dob?.isValid}
                      hasValue={fieldValidation.dob?.hasValue}
                    />
                  </label>
                  <input
                    type="date"
                    ...
                    className={`w-full px-3 py-2 border rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-black ${
                      errors.dob
                        ? "border-red-500"
                        : fieldValidation.dob?.hasValue
                          ? fieldValidation.dob?.isValid
                            ? "border-green-500"
                            : "border-red-500"
                          : "border-gray-400"
                    }`}
                    ...
                    className={`w-full px-3 py-2 border rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-black ${
                      errors.health_card_number
                        ...
                        : fieldValidation.health_card_number?.hasValue
                          ? fieldValidation.health_card_number?.isValid
                            ? "border-green-500"
                            : "border-red-500"
                          : "border-gray-400"
                    }`}
                    ...
                    className={`w-full px-3 py-2 border rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-black ${
                      errors.phone_number
                        ...
                        : fieldValidation.phone_number?.hasValue
                          ? fieldValidation.phone_number?.isValid
                            ? "border-green-500"
                            : "border-red-500"
                          : "border-gray-400"
                    }`}
                ...
                <div className="bg-gray-100 rounded-lg p-6 border border-gray-400">
                  ...
                  <div className="text-sm text-gray-800 space-y-2 mb-4">
                    <p>
                      By registering for our screening services, you consent to:
                    </p>

                    <ul className="list-disc list-inside space-y-1 ml-4">
                      <li>
                        <strong>Testing Services:</strong> Undergo Hepatitis C
                        and HIV testing and/or allow us to review your medical
                        records to determine next steps in your care
                      </li>
                      <li>
                        <strong>Communication:</strong> Be contacted by our team
                        regarding your testing and follow-up care
                      </li>
                      <li>
                        <strong>Information Sharing:</strong> Have your
                        registration details shared with our support team for
                        scheduling and providing services
                      </li>
                      <li>
                        <strong>Confidentiality:</strong> All personal
                        information will be kept confidential and used only to
                        facilitate your healthcare services
                      </li>
                      <li>
                        <strong>Data Retention:</strong> Your information will
                        be retained only as long as necessary, then securely
                        disposed of
                      </li>
                      <li>
                        <strong>Your Rights:</strong> Access and correct your
                        information, and withdraw consent at any time
                      </li>
                    </ul>
                  </div>
                  ...
                  <div className="flex items-start space-x-3">
                    ...
                    >
                      <strong>I understand and agree</strong> to the testing and
                      privacy practices described above. *
                    </label>
                  </div>
                  {errors.consent_given && (
              ...
              <div className="mt-3 p-4 bg-gray-100 rounded-lg border border-gray-400">
                <p className="text-sm text-black">
                  ...
                  <strong> 1-833-420-3733</strong> or{" "}
                  <a
                    href="/contact"
                    className="underline"
                    onClick={() => {
