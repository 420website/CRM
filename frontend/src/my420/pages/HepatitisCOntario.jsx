...
const HepatitisCOntario = () => {
  return (
    <div className="bg-white">
      <Helmet>
        <title>
          Hepatitis C Ontario | #1 Free HCV Testing & Treatment Services Ontario
          | MY420.CA
        </title>
        <meta
          name="description"
          content="Ontario's leading Hepatitis C testing provider. Free confidential Hepatitis C Ontario services across all Ontario communities. 2000+ screened, 98% linked to care, 97% treatment success rate. Expert Hepatitis C Ontario care since 2020."
        />
        <meta
          name="keywords"
          content="hepatitis C ontario, hepatitis c ontario, Hepatitis C Ontario testing, hepatitis C ontario treatment, hepatitis C ontario services, ontario hepatitis C, hepatitis C toronto, hepatitis C ottawa, hepatitis C hamilton, hepatitis C london ontario, free hepatitis C testing ontario"
        />
        <link rel="canonical" href="https://my420.ca/hepatitis-c-ontario" />
        <meta
          property="og:title"
          content="Hepatitis C Ontario | #1 Free Testing & Treatment Services"
        />
        <meta
          property="og:description"
          content="Ontario's premier Hepatitis C provider. Free testing, treatment connections, and support across all Ontario communities. 2000+ screened with proven results."
        />
        <meta
          property="og:url"
          content="https://my420.ca/hepatitis-c-ontario"
        />
        ...
        <meta
          name="twitter:title"
          content="Hepatitis C Ontario | Free Confidential Testing"
        />
        <meta
          name="twitter:description"
          content="Leading Hepatitis C Ontario provider. Free confidential testing across all Ontario communities."
        />
        <meta name="robots" content="index, follow" />
        <meta
          name="author"
          content="MY420.CA - Hepatitis C Ontario Specialists"
        />
      ...
      <section className="bg-gradient-to-r from-red-600 to-red-800 text-white py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <h1 className="text-5xl font-bold mb-6">Hepatitis C Ontario</h1>
            <h2 className="text-3xl font-semibold mb-4">
              #1 Hepatitis C Testing & Treatment Services Across Ontario
            </h2>
            <p className="text-xl mb-8 max-w-4xl mx-auto">
              Ontario's premier Hepatitis C testing and treatment connection
              service. Free, confidential, and accessible Hepatitis C Ontario
              services across all Ontario communities. 2000+ people screened
              with 98% linked to care and 97% treatment success rate.
            </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              We provide Hepatitis C Ontario services across all regions, from
              major cities to rural communities.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-white rounded-lg shadow-md p-6">
              ...
              <p className="text-gray-600 mb-4">
                Comprehensive Hepatitis C Ontario services throughout the GTA
                including Toronto, Mississauga, Brampton, Markham, and
                surrounding areas.
              </p>
            ...
            <div className="bg-white rounded-lg shadow-md p-6">
              ...
              <p className="text-gray-600 mb-4">
                Hepatitis C Ontario services in Ottawa, Kingston, Cornwall, and
                throughout Eastern Ontario with bilingual support available.
              </p>
              <ul className="text-sm text-gray-500 space-y-1">
            ...
            <div className="bg-white rounded-lg shadow-md p-6">
              ...
              <p className="text-gray-600 mb-4">
                Hepatitis C Ontario coverage in London, Windsor, Sarnia,
                Chatham, and surrounding Southwestern Ontario communities.
              </p>
              <ul className="text-sm text-gray-500 space-y-1">
            ...
            <div className="bg-white rounded-lg shadow-md p-6">
              ...
              <p className="text-gray-600 mb-4">
                Hepatitis C Ontario services in Hamilton, St. Catharines,
                Niagara Falls, and throughout the Greater Hamilton Area.
              </p>
              <ul className="text-sm text-gray-500 space-y-1">
            ...
            <div className="bg-white rounded-lg shadow-md p-6">
              ...
              <p className="text-gray-600 mb-4">
                Hepatitis C Ontario services extending to Sudbury, Thunder Bay,
                Sault Ste. Marie, and remote Northern Ontario communities.
              </p>
              <ul className="text-sm text-gray-500 space-y-1">
            ...
            <div className="bg-white rounded-lg shadow-md p-6">
              ...
              <p className="text-gray-600 mb-4">
                Hepatitis C Ontario coverage in Barrie, Orillia, Peterborough,
                and throughout Central Ontario including cottage country.
              </p>
              <ul className="text-sm text-gray-500 space-y-1">
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Our proven track record of Hepatitis C Ontario care demonstrates
              our commitment to eliminating Hepatitis C across Ontario.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="text-center bg-red-50 rounded-lg p-8">
              ...
              <div className="text-gray-600">
                Estimated current cases in Ontario
              </div>
            </div>
            <div className="text-center bg-red-50 rounded-lg p-8">
              ...
              <div className="text-gray-600">
                Ontarians screened for Hepatitis C
              </div>
            </div>
            <div className="text-center bg-red-50 rounded-lg p-8">
              ...
              <div className="text-gray-600">
                Successfully connected to treatment
              </div>
            </div>
            <div className="text-center bg-red-50 rounded-lg p-8">
              ...
              <div className="text-gray-600">
                Hepatitis C cure rate in Ontario
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Ontario has specific Hepatitis C challenges that make testing and
              treatment crucial for public health and individual wellbeing.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="bg-gray-800 rounded-lg p-8">
              <h3 className="text-2xl font-semibold mb-4 text-red-400">
                Ontario Hepatitis C Risk Factors
              </h3>
            ...
            <div className="bg-gray-800 rounded-lg p-8">
              <h3 className="text-2xl font-semibold mb-4 text-red-400">
                Hepatitis C Ontario Treatment Benefits
              </h3>
              <ul className="space-y-3 text-gray-300">
                <li className="flex items-start">
                  <span className="text-red-400 mr-2">•</span>
      ...
      <section className="py-16 bg-red-600 text-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl mb-8">
            Join thousands of Ontarians who have taken control of their health
            with our free, confidential Hepatitis C Ontario testing services.
