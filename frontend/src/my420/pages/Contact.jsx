...
const Contact = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    const result = await WebpageServices.send_contact_message(formData);

    if (result.success) {
      setSubmitStatus({
        type: "success",
        message: "Thank you for your message! We will get back to you soon.",
        messageId: result.data.contact_id,
      });
      setFormData({
        first_name: "",
        last_name: "",
      ...
      <div className="min-h-screen bg-gray-100 pt-8 pb-6">
        <div className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-white rounded-lg shadow-md p-8 text-center border border-gray-300">
            ...
            <p className="text-lg text-gray-800 mb-6">{submitStatus.message}</p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="text-xl text-gray-200 max-w-3xl mx-auto">
              ...
              anytime for confidential assistance and information about our
              testing services.
            </p>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-4">
            ...
            <p className="text-xl text-gray-700 max-w-3xl mx-auto">
              Multiple ways to reach us for support, questions, or to schedule
              testing.
            </p>
          </div>
      ...
      <section className="pt-4 pb-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
            ...
            <div
              id="contact-form"
              className="bg-white rounded-lg shadow-md p-8 border border-gray-300 mb-8"
            >
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                <div>
                  ...
                  <input
                    ...
                    placeholder="Your first  name (letters only)"
                  />
                </div>
                ...
                <div>
                  ...
                  <input
                    ...
                    placeholder="Your last  name (letters only)"
                  />
                </div>
            ...
            <div className="space-y-4">
              <div className="bg-white rounded-lg shadow-md p-6 border border-gray-300">
                ...
                <p className="text-gray-600 mb-4 text-sm">
                  Learn about available treatments and what to expect during the
                  process.
                </p>
      ...
      <section className="pt-4 pb-4 bg-white text-black">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl mb-4 text-gray-700">
            Take the first step toward better health with our confidential
            testing services.
          </p>
          <Link
