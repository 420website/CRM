...
class TestsTabRegistrationIdTester:
    ...
    def test_update_test(self):
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                get_response = requests.get(get_tests_url, headers=headers, timeout=10)
    ...
    def run_all_tests(self):
        ...
        # Add a delay before retrieving tests to ensure they're fully saved
        logging.info("\nWaiting 2 seconds before retrieving tests...")
        time.sleep(2)
