...
#             "SUPPORT_EMAIL", "420pharmacyprogram@gmail.com"
#         )
#
...
#         )
#         logging.error(
#             f"🚨 CLIENT REGISTRATION EMAIL - Environment SUPPORT_EMAIL: {os.environ.get('SUPPORT_EMAIL', 'NOT SET')}"
#         )
#
...
#         logging.error(
#             f"🚨 CONTACT EMAIL - Environment SUPPORT_EMAIL: {os.environ.get('SUPPORT_EMAIL', 'NOT SET')}"
#         )
#
#         # Create email content
...
#         )
#         logging.error(
#             f"🚨 ASYNC FINALIZATION EMAIL - Environment SUPPORT_EMAIL: {os.environ.get('SUPPORT_EMAIL', 'NOT SET')}"
#         )
#
#         email_body = f"""
